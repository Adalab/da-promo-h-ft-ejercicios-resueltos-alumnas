...
-- Busca aquellos registros de la tabla customers que correspondan a clientes de USA
...
-- Selecciona el país (country)
-- correspondiente a los registros de clientes con un límite de crédito (credit_limit) mayor que $10000.
