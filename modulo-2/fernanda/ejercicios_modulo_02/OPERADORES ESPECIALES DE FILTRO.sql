...
ON employees.last_name = customers.contact_last_name;
...
/* 4. Queremos ver ahora el employee_number como 'Número empleado', first_n_ame como 'nombre Empleado'
...
FROM customers
WHERE city LIKE '%on';
/* 7. Encuentra los campos nombre del cliente, ciudad de aquellas ciudades de la tabla de customers 
...
/* 8. Encuentra el nombre del cliente, primera dirección y ciudad de aquellas ciudades 
...
/* 9. Encuentra el nombre del cliente, primera dirección y ciudad de aquellas ciudades que contengan el número 3 en su dirección postal
