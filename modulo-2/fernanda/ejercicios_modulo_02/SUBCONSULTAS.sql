...
SELECT city, count(customer_number) AS numero_clientes_ciudad
FROM customers
GROUP BY city;
...
FROM customers
GROUP BY city
HAVING MAX(numero_clientes_ciudad)
/*EJERCICIO 3:
Por último, usa todas las consultas anteriores para seleccionar el customerNumber, nombre y apellido de las clientas asignadas
